...
.. figure:: /generated/figures/declared_physics.png
   ...
   operator [1]_ in place of the two scalar factors.
...
[2]_, and it means the arithmetic can be done in real numbers: the shift's
...
component along :math:`z` carries states off the line. You never ask for this
...
* **Intravoxel field variation.** Off-resonance is a per-voxel constant, so
  :math:`T_2'` dephasing comes from a distribution across voxels rather than
  from within one.
* **A shaped pulse, unless you ask.** Pulses are instantaneous rotations by
  ...
  over slice position and effective flip angle [3]_, read back by cubic
